...
/**
 * @author pluxsuwong
 * Gamma implementation for the HantoPieceFactory
 */
public class GammaHantoPieceFactory implements HantoPieceFactory 
{
	private static final GammaHantoPieceFactory instance = new GammaHantoPieceFactory();
	
	/**
	 * Default private descriptor.
	 */
	private GammaHantoPieceFactory()
	{
	 ...
	 * @return the instance
	 */
	public static GammaHantoPieceFactory getInstance()
	{
		return instance;
	}
